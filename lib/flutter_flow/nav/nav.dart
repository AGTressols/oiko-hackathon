...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'flowRegistro',
          path: '/flowRegistro',
          builder: (context, params) => const FlowRegistroWidget(),
        ),
        FFRoute(
          name: 'settings',
          path: '/settings',
        ...
        FFRoute(
          name: 'infoUsuario',
          path: '/infoUsuario',
          builder: (context, params) => const InfoUsuarioWidget(),
        ),
        FFRoute(
          name: 'transaccionRegistrada',
          path: '/transaccionRegistrada',
          builder: (context, params) => const TransaccionRegistradaWidget(),
        ),
        FFRoute(
          name: 'flowTraspaso',
          path: '/flowTraspaso',
          builder: (context, params) => const FlowTraspasoWidget(),
        ),
        FFRoute(
          name: 'personalizacionUsuario',
          path: '/personalizacionUsuario',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'personalizacionUsuario')
              : const PersonalizacionUsuarioWidget(),
        ),
        FFRoute(
          name: 'categorias',
          path: '/categorias',
        ...
        FFRoute(
          ...
          path: '/detalleCuenta',
          asyncParams: {
            'parametroCuenta': getDoc(['Cuentas'], CuentasRecord.fromSnapshot),
          },
          builder: (context, params) => DetalleCuentaWidget(
        ...
        FFRoute(
          name: 'nuevaCategoriaa',
          path: '/nuevaCategoriaa',
