                                ...
                                children: [
                                  ...
                                  Stack(
                                    children: [
                                      ...
                                      if ((FFAppState().flowCuenta.nombre !=
                                                  '') &&
                                          (FFAppState().flowMonto >= 1.0))
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      alignment:
                                                                          const AlignmentDirectional(
                                                                              ...
                                                                              0.0),
                                                                      children: [
                                                                        if (FFAppState().flowCuenta.cuentaRef?.id !=
                                                                            listViewCuentasRecord.reference.id)
                                                                          InkWell(
                                                                            splashColor:
                                                                                Colors.transparent,
                                                                            focusColor:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              if (FFAppState().flowCuentaCredito.cuentaRef == listViewCuentasRecord.reference) {
                                                                                FFAppState().flowCuentaCredito = FlowCuentaStruct();
                                                                                safeSetState(() {});
                                                                                return;
                                                                              } else {
                                                                                ...
                                                                                safeSetState(() {});
                                                                                _model.esDivisa = listViewCuentasRecord.divisa != '\$ARS';
                                                                                safeSetState(() {});
                                                                                if (listViewCuentasRecord.divisa != '\$ARS') {
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              decoration: BoxDecoration(
                                                                                color: FFAppState().flowCuentaCredito.cuentaRef == listViewCuentasRecord.reference ? FlutterFlowTheme.of(context).primary : FlutterFlowTheme.of(context).secondaryBackground,
                                                                                borderRadius: BorderRadius.circular(100.0),
                                                                              ),
                                                                              child: Row(
                                                                                mainAxisSize: MainAxisSize.max,
                                                          ...
                                                          return FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              if (_model
                                                                ...
                                                                FFAppState()
                                                                        .flowMonto =
                                                                    functions.cambiarSimbolo(double.tryParse(_model
                                                                        .setMontoTextController
                                                                        .text))!;
                                                                safeSetState(
                                                                    () {});
                                                              ...
                                                              if (_model
                                                                ...
                                                                await TransaccionesRecord
                                                                    ...
                                                                    .set(
                                                                      ...
                                                                      montoAhorro:
                                                                          functions
                                                                              .cambiarSimbolo(FFAppState().flowMonto),
                                                                      montoDivisa:
                                                                          0.0,
                                                                      timestamp:
                                                                          getCurrentTimestamp,
