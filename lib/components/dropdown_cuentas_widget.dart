...
import 'dropdown_cuentas_model.dart';
export 'dropdown_cuentas_model.dart';

class DropdownCuentasWidget extends StatefulWidget {
  const DropdownCuentasWidget({
    super.key,
    bool? ahorro,
  }) : ahorro = ahorro ?? false;
  ...
  @override
  State<DropdownCuentasWidget> createState() => _DropdownCuentasWidgetState();
}

class _DropdownCuentasWidgetState extends State<DropdownCuentasWidget> {
  late DropdownCuentasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DropdownCuentasModel());
  }
