...
import '/components/dropdown_categorias_widget.dart';
import '/components/dropdown_cuentas_widget.dart';
import '/components/dropdown_etiquetas_widget.dart';
...
import 'detalle_transaccion_model.dart';
export 'detalle_transaccion_model.dart';

class DetalleTransaccionWidget extends StatefulWidget {
  const DetalleTransaccionWidget({
    super.key,
...
class _DetalleTransaccionWidgetState extends State<DetalleTransaccionWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalleTransaccionModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().flowCategoria = FlowCategoriaStruct(
        nombre: widget.parametroTransaccion?.categoria,
        logo: widget.parametroTransaccion?.logo,
        categoriaRef: widget.parametroTransaccion?.refCategoria,
      );
      FFAppState().flowEtiqueta = FlowEtiquetaStruct(
        nombre: widget.parametroTransaccion?.etiqueta,
        etiquetaRef: widget.parametroTransaccion?.refEtiqueta,
      );
      safeSetState(() {});
      _model.addToMovimiento(widget.parametroTransaccion!.movimiento);
      safeSetState(() {});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          key: scaffoldKey,
          backgroundColor: widget.parametroTransaccion?.movimiento == 'Gasto'
          ...
          appBar: AppBar(
            ...
            title: Text(
              widget.parametroTransaccion?.movimiento == 'Gasto'
                  ? 'Egreso'
                  : 'Ingreso',
                              ...
                              return GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: SizedBox(
                                    height:
                                        MediaQuery.sizeOf(context).height * 0.7,
                                    child: DropdownCategoriasWidget(
                                      movimiento: _model.movimiento,
                                    ),
                                  ),
                                ),
                              );
                          ...
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 0.0, 0.0),
                              child: Text(
                                FFAppState().flowCategoria.nombre,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Outfit',
                      ...
                      child: InkWell(
                              ...
                              return GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: SizedBox(
                                    height:
                                        MediaQuery.sizeOf(context).height * 0.7,
                                    child: DropdownEtiquetasWidget(
                                      cateogoria: widget
                                          .parametroTransaccion!.refCategoria!,
                                    ),
                                  ),
                                ),
                              );
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            FFAppState().flowEtiqueta.nombre,
                            '+ Etiqueta',
                          ),
                          style:
                        ...
                        if (!widget.divisa!)
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                if (widget.parametroTransaccion?.refCuenta ==
                                  ...
                                  await FFAppState()
                                    ...
                                    ...mapToFirestore(
                                      {
                                        'tap': FieldValue.increment(functions
                                            .resta(
                                  ...
                                  await widget.parametroTransaccion!.refCuenta!
                                      .update({
                                    ...mapToFirestore(
                                      {
                                        'tap': FieldValue.increment(widget
                                            ...
                                            : functions.cambiarSimbolo(widget
                                                .parametroTransaccion?.monto)!),
                                      },
                                    ),
                                  });
                                ...
                                await widget
                                  ...
                                  etiqueta:
                                      FFAppState().flowEtiqueta.etiquetaRef,
                                ...
                                FFAppState().insertAtIndexInCategoriasHistorico(
                                    0, 'Todas');
                                FFAppState().update(() {});
                                FFAppState()
