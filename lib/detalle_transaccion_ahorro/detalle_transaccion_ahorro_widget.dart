...
import 'detalle_transaccion_ahorro_model.dart';
export 'detalle_transaccion_ahorro_model.dart';

class DetalleTransaccionAhorroWidget extends StatefulWidget {
  const DetalleTransaccionAhorroWidget({
    super.key,
  ...
  @override
  State<DetalleTransaccionAhorroWidget> createState() =>
      _DetalleTransaccionAhorroWidgetState();
}

class _DetalleTransaccionAhorroWidgetState
    extends State<DetalleTransaccionAhorroWidget> {
  late DetalleTransaccionAhorroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalleTransaccionAhorroModel());
    ...
    _model.montoTextController ??= TextEditingController(
        text: widget.parametroTransaccion?.montoDivisa != 0.0
            ? widget.parametroTransaccion?.montoDivisa.toString()
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CuentasRecord>(
      stream: CuentasRecord.getDocument(
          widget.parametroTransaccion!.refCuentaCredito!),
      builder: (context, snapshot) {
        ...
        final detalleTransaccionAhorroCuentasRecord = snapshot.data!;
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await widget
                                      ...
                                      monto: functions.cambiarSimbolo(
                                          double.tryParse(
                                              _model.montoTextController.text)),
