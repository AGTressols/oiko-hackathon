...
class _LoginPageWidgetState extends State<LoginPageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().cacheCuentas = [];
      FFAppState().cacheEtiquetas = [];
      FFAppState().ultimoTimestampTransaccion = '';
      FFAppState().transaccionesAjuste = [];
      FFAppState().todasTransacciones = [];
      FFAppState().padreMenos = [];
