          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FlutterFlowDropDown<String>(
                    controller: _model.dropDownValueController ??=
                      ...
                      _model.dropDownValue ??= FFAppState().flowMovimiento,
                    ),
                ...
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(64.0, 12.0, 64.0, 0.0),
                  child: TextFormField(
                        ...
                        if ((_model.textController1.text != '') &&
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[0],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[1],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[2],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[3],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[4],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[5],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[6],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[7],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[8],
                                activa: true,
                              ));
                          ...
                          await EtiquetasRecord.collection
                              ...
                              .set(createEtiquetasRecordData(
                                uid: currentUserUid,
                                categoria: _model.nuevaCategoria?.reference,
                                etiqueta: FFAppState().modificacionEtiquetas[9],
                                activa: true,
                              ));
                        } else {
                          await showDialog(
