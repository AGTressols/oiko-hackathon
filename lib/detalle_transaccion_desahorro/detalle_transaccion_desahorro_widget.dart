...
import 'detalle_transaccion_desahorro_model.dart';
export 'detalle_transaccion_desahorro_model.dart';

class DetalleTransaccionDesahorroWidget extends StatefulWidget {
  const DetalleTransaccionDesahorroWidget({
    super.key,
  ...
  @override
  State<DetalleTransaccionDesahorroWidget> createState() =>
      _DetalleTransaccionDesahorroWidgetState();
}

class _DetalleTransaccionDesahorroWidgetState
    extends State<DetalleTransaccionDesahorroWidget> {
  late DetalleTransaccionDesahorroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalleTransaccionDesahorroModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CuentasRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detalleTransaccionDesahorroCuentasRecord = snapshot.data!;
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await widget
                                      ...
                                      montoAhorro: functions.cambiarSimbolo(
                                          double.tryParse(
                                              _model.montoTextController.text)),
